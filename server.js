...
const { mirrorShopResponse } = require("./supabase-shop-api");

const HOST = "0.0.0.0";
const PORT = Number(process.env.PORT || 3000);
const PRIMARY_APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbz1jACwi00bxHlSEdA3Ap7fH1oteIBGdBF0C0pRko9RLERa2lHDDwzK76pltLEqnkQ2/exec";
...
async function proxyShopApi(request, response) {
  ...
  for (const upstreamUrl of APPS_SCRIPT_URLS) {
    try {
      ...
      await mirrorShopResponse(payload, upstreamJson);
