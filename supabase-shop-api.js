...
function mapDailyPassRewardItemForClient(item) {
  ...
  switch (normalizedType) {
    ...
    case "specialLogo":
      return { type: "specialLogo", qty, label: "Logo especial", icon: "./assets/logo-perrisushi.png" };
    case "specialFrame":
      return { type: "specialFrame", qty, label: "Marco especial", icon: "./assets/marco-logo.png" };
    default:
