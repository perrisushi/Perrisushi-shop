...
const PERRI_CASILLAS_REWARDS = [
  { label: "100 PG", kind: "polvoGema", amount: 100, image: "./assets/polvo-de-gema.png", weight: 20, inventoryDelta: { polvoGema: 100 } },
  { label: "200 PG", kind: "polvoGema", amount: 200, image: "./assets/polvo-de-gema.png", weight: 16, inventoryDelta: { polvoGema: 200 } },
  { label: "400 PG", kind: "polvoGema", amount: 400, image: "./assets/polvo-de-gema.png", weight: 7, inventoryDelta: { polvoGema: 400 } },
  { label: "200 PC", kind: "pc", amount: 200, image: "./assets/moneda.png", weight: 18, inventoryDelta: { pc: 200 } },
  { label: "500 PC", kind: "pc", amount: 500, image: "./assets/moneda.png", weight: 10, inventoryDelta: { pc: 500 } },
  { label: "1 Moneda", kind: "monedas", amount: 1, image: "./assets/moneda.png", weight: 10, inventoryDelta: { monedas: 1 } },
  { label: "1 Duelo", kind: "duelo", amount: 1, image: "./assets/duelo.png", weight: 8, inventoryDelta: { duelo: 1 } },
  { label: "1 Fragmento de llave", kind: "fragmentoKey", amount: 1, image: "./assets/llave.png", weight: 6, inventoryDelta: { fragmentoKey: 1 } },
  { label: "1 Perricita", kind: "perricita", amount: 1, image: "./assets/perricita.png", weight: 4, inventoryDelta: { perricita: 1 } },
  { label: "1 Llave", kind: "llaves", amount: 1, image: "./assets/llave.png", weight: 1, inventoryDelta: { llaves: 1 } }
];
...
function createPerriCasillasBoard() {
  return Array.from({ length: 36 }, () => {
    const reward = pickWeightedEntry(PERRI_CASILLAS_REWARDS);
    return {
      opened: false,
      reward: {
        label: reward.label,
