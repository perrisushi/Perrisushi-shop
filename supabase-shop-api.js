...
const CHAT_MESSAGE_LIST_LIMIT = 80;
...
async function listChatMessages(limit = CHAT_MESSAGE_LIST_LIMIT) {
  ...
  const rows = await fetchRows("shop_chat_messages", {
    select: "id,nick,logo_id,message,reply_to_message_id,created_at",
